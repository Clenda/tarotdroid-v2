...
import org.nla.tarotdroid.core.helpers.RandomHelper;
...
public class InsertMockGameSetsTask extends AsyncTask<Void, String, Void> {
    ...
    public InsertMockGameSetsTask(
            final Context context,
            final int gameSetCount,
            final int maxGameCount,
        ...
        try {
            for (int i = 0; i < this.gameSetCount && this.goOn; ++i) {
                ...
                for (int j = 0; j < nbGamesToCreate && this.goOn; ++j) {
                    ...
                    // TODO Get context
                    dalService.saveGame(game, gameSet);
                }
            }
        } catch (Exception e) {
