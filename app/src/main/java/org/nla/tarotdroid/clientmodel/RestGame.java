...
public class RestGame implements Serializable {
     ...
     */
    public List<RestPlayer> getDeadPlayers() {
     ...
     * @param deadPlayers
     */
    public void setDeadPlayers(List<RestPlayer> deadPlayers) {
     ...
     */
    public List<RestPlayer> getPlayersWithMisery() {
     ...
     */
    public void setPlayersWithMisery(List<RestPlayer> playersWithMisery) {
