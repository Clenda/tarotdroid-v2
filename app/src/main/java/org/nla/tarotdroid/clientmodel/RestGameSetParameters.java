...
public class RestGameSetParameters {
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                      ...
                      .add("announcedAndSucceededChelemPoints",
                           this.announcedAndSucceededChelemPoints)
                      .add("notAnnouncedButSucceededChelemPoints",
                           this.notAnnouncedButSucceededChelemPoints)
