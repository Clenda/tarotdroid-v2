...
import org.nla.tarotdroid.helpers.ConnexionHelper;
import org.nla.tarotdroid.ui.tasks.IAsyncCallback;
import org.nla.tarotdroid.ui.tasks.ShortenUrlTask;
			...
			Thread thread = new Thread(new Runnable() {
				...
				public void run() {
					try {
						...
						TwitterConnectActivity.this.startActivity(new Intent(Intent.ACTION_VIEW, Uri
