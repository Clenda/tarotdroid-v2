...
public final class UIConstants {
	 ...
	 */
	public static final LayoutParams PLAYERS_LAYOUT_PARAMS = new LinearLayout.LayoutParams(
	 ...
	 */
	public static final LayoutParams TABGAMESET_LAYOUT_PARAMS = new LinearLayout.LayoutParams(
			LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT, 1);
	static {
	 ...
	 */
	public static final LayoutParams CALLED_COLOR_LAYOUT_PARAMS = new LinearLayout.LayoutParams(
			LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT, (float)0.7);
	static {
	 ...
	 */
	public static final LayoutParams TXT_SCORE_LAYOUT_PARAMS = new LinearLayout.LayoutParams(
			LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT, (float)0.3);
