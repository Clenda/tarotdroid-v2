...
*/
package org.nla.tarotdroid.core.dal.sql.adapters;
...
import org.nla.tarotdroid.core.dal.sql.adapters.enums.GameTypes;
...
public class GameDatabaseAdapter extends BaseAdapter {
	...
	public List<Long> deleteAllGamesInGameSet(final Map<Class<? extends BaseGame>, List<Long>> gameIds) {
		...
		this.database.delete(DatabaseV5Constants.TABLE_GAME, DatabaseV5Constants.COL_GAME_ID + SqlHelper
				.formatIdsForSqlInClause(allGameIds), null);
	...
	public void fetchAllStdGames(final Map<Long, List<BaseGame>> gamesInTheRepositoryByGameSet) {
		...
		while(dataSource.moveToNext()) {
			try {
				...
				switch(GameTypes.valueOf(dataSource.getString(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_GAME_TYPE)))) {
					case std3game :
				...
				game.setCreationTs(new Date(dataSource.getLong(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_GAME_TIMESTAMP))));
				game.setIndex(dataSource.getInt(dataSource.getColumnIndex(DatabaseV5Constants.COL_GAME_INDEX)));
				game.setDeadPlayer(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_GAME_DEAD1_ID))));
				game.setDealer(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_GAME_DEALER_ID))));
				
				game.setLeadingPlayer(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_LEADER_ID))));
				game.setBet(Bet.valueOf(dataSource.getString(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_BET))));
				game.setNumberOfOudlers(dataSource.getInt(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_OUDLERS)));
				game.setPoints(dataSource.getInt(dataSource.getColumnIndex(DatabaseV5Constants.COL_STDGAME_POINTS)));
				game.setTeamWithPoignee(Team.valueOf(dataSource.getString(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_HANDFUL))));
				game.setTeamWithDoublePoignee(Team.valueOf(dataSource.getString(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_DOUBLEHANDFUL))));
				game.setTeamWithTriplePoignee(Team.valueOf(dataSource.getString(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_TRIPLEHANDFUL))));
				game.setPlayerWithMisery(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_MISERY))));
				game.setTeamWithKidAtTheEnd(Team.valueOf(dataSource.getString(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_KIDATTHEEND))));
				game.setChelem(Chelem.valueOf(dataSource.getString(dataSource.getColumnIndex(
						DatabaseV5Constants.COL_STDGAME_SLAM))));
				
				// data specifics to StandardTarot5Game
				if (game instanceof StandardTarot5Game) {
					StandardTarot5Game std5game = (StandardTarot5Game)game;
					std5game.setCalledKing(King.valueOf(dataSource.getString(dataSource.getColumnIndex(
							DatabaseV5Constants.COL_STDGAME_KING))));
					std5game.setCalledPlayer(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
							DatabaseV5Constants.COL_STDGAME_CALLED_ID))));
				}
		...
		while(dataSource.moveToNext()) {
			...
			switch(GameTypes.valueOf(dataSource.getString(dataSource.getColumnIndex(
				...
				case belgian4game :
					...
					belgian4game.setFourth(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
							DatabaseV5Constants.COL_BELGIANGAME_FOURTH_ID))));
					game = belgian4game;
					break;
				case belgian5game :
					BelgianTarot5Game belgian5game = new BelgianTarot5Game();
					belgian5game.setFourth(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
							DatabaseV5Constants.COL_BELGIANGAME_FOURTH_ID))));
					belgian5game.setFifth(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
							DatabaseV5Constants.COL_BELGIANGAME_FIFTH_ID))));
					game = belgian5game;
					break;
				default:
			...
			game.setPlayers(this.gamesPlayerListsInRepository.get(gameId));
			game.setFirst(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
					DatabaseV5Constants.COL_BELGIANGAME_FIRST_ID))));
			game.setSecond(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
					DatabaseV5Constants.COL_BELGIANGAME_SECOND_ID))));
			game.setThird(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
					DatabaseV5Constants.COL_BELGIANGAME_THIRD_ID))));
	...
	public void fetchAllPenaltyGames(final Map<Long, List<BaseGame>> gamesInTheRepositoryByGameSet) {
		...
		while(dataSource.moveToNext()) {
			...
			game.setPlayers(this.gamesPlayerListsInRepository.get(gameId));
			game.setPenaltedPlayer(this.playersInRepository.get(dataSource.getLong(dataSource.getColumnIndex(
					DatabaseV5Constants.COL_PENALTYGAME_PENALTED_ID))));
